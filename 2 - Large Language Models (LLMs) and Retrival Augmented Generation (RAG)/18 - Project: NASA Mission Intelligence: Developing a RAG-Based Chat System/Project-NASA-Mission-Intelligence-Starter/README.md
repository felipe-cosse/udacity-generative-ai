...
├── evaluation_dataset.txt  # JSON-formatted test questions and expected responses
...
`evaluation_dataset.txt` is a JSON-formatted text file containing source-grounded
questions and expected responses for Apollo 11, Apollo 13, and Challenger. Its test
cases cover mission overview, emergency response, disaster analysis, crew, technical,
and timeline questions. Each case also identifies the local source document used to
